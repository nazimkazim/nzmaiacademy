...
export const langPairOptions = [
  { label: "Choose a language pair", value: 0 },
  { label: "English-Russian", value: "English-Russian" }
];
...
export const grammarOptions = [
  { label: "Choose the grmmar of the word", value: 0 },
  { label: "Action noun", value: "Action noun" },
  { label: "Reciprocal voice", value: "Reciprocal voice" },
  { label: "Reflexive voice", value: "Reflexive voice" },
  { label: "Grammar", value: "Grammar" },
  { label: "Dative case", value: "Dative case" },
  { label: "Participle", value: "Participle" },
  { label: "Singular", value: "Singular" },
  { label: "Plural", value: "Plural" },
  { label: "Iterative aspect", value: "Iterative aspect" },
  { label: "Momentary aspect", value: "Momentary aspect" },
  { label: "Aditive", value: "Aditive" },
  { label: "Comparative", value: "Comparative" },
  { label: "Passive voice", value: "Passive voice" },
  { label: "Genitive case", value: "Genitive case" },
  { label: "Diminutive form", value: "Diminutive form" }
];
